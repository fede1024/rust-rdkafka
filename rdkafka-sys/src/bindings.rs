...
use libc::{c_char, c_int, c_void, size_t, sockaddr, ssize_t, FILE, addrinfo};
...
extern "C" {
    pub fn rd_kafka_AdminOptions_set_match_consumer_group_states(
        ...
        consumer_group_states_cnt: size_t,
    ) -> *mut rd_kafka_error_t;
}
extern "C" {
