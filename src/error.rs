...
impl fmt::Debug for KafkaError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            KafkaError::StoreOffset(err) => write!(f, "KafkaError (Store offset error: {})", resp_err_description(err)),
            ...
            KafkaError::SetPartitionOffset(err) => write!(f, "KafkaError (Set partition offset error: {})", resp_err_description(err)),
            ...
            KafkaError::Global(err) => write!(f, "KafkaError (Global error: {})", resp_err_description(err)),
        }
    }
}
...
impl fmt::Display for KafkaError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            KafkaError::StoreOffset(err) => write!(f, "Store offset error: {}", resp_err_description(err)),
            ...
            KafkaError::SetPartitionOffset(err) => write!(f, "Set partition offset error: {}", resp_err_description(err)),
            ...
            KafkaError::Global(err) => write!(f, "Global error: {}", resp_err_description(err)),
        }
    }
}
